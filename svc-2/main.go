...
func RegisterHandler(generalConfig *config.GeneralConfig, tracer opentracing.Tracer) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = sendNotification(r.Context(), generalConfig, tracer)
		if err != nil {
			log.Printf("request payload: %v+\n", userReg)
...
func sendNotification(ctx context.Context, generalConfig *config.GeneralConfig, tracer opentracing.Tracer) error {
